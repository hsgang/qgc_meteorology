...
void Vehicle::_handleV2_extension(mavlink_message_t& message)
{
    ...
    _sensorFactGroup.sensorTemp()->setRawValue(sP.sensorTempRaw * 1e-1);
    _sensorFactGroup.sensorHumi()->setRawValue(sP.sensorHumiRaw * 1e-1);
    _sensorFactGroup.sensorBaro()->setRawValue(sP.sensorBaroRaw * 1e-1);
    _sensorFactGroup.sensorWindDir()->setRawValue(sP.sensorWindDirRaw * 1e-1);
    _sensorFactGroup.sensorWindSpd()->setRawValue(sP.sensorWindSpdRaw * 1e-1);
}
...
void Vehicle::_writeJsonLine()
{
    ...
    if(_armed==true){
        ...
        QString Voltage = getFactGroup("battery")->getFact("voltage")->cookedValueString();
        QString BatteryPercent = getFactGroup("battery")->getFact("percentRemaining")->cookedValueString();
        ...
        jsonFactValue.append("\t\"WindSpd\": " + WindSpd + "0,\r\n");
